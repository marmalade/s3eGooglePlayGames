...
void JNICALL s3eGPG_INITIALIZATION( JNIEnv* env,  jobject obj, jint status, jstring errorMsg);
...
s3eResult s3eGooglePlayGamesInit_platform()
{
    ...
    jclass cls = s3eEdkAndroidFindClass("com/ideaworks3d/marmalade/s3egoogleplaygames/s3eGooglePlayGames");
    if (!cls)
        goto fail;
